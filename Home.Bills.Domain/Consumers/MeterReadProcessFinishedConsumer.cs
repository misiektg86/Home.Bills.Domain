...
{
    public class MeterReadProcessFinishedConsumer : IConsumer<MeterReadProcessFinished>
    {
        ...
        public async Task Consume(ConsumeContext<MeterReadProcessFinished> context)
        {
